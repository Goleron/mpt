...
def manage_table(self):
        print("Управление столами")
        choice = input("Введите 'add' для добавления нового стола или 'update' для обновления существующего: ")
        table_id = int(input("Введите идентификатор стола: "))
        capacity = int(input("Введите вместимость стола: "))

        if choice == 'add' or choice == 'update':
            self.add_new_table(table_id, capacity)
        else:
